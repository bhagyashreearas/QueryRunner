...
public class QueryFrame extends javax.swing.JFrame
{
     ...
     * It will also set the default state of the Command Buttons and combo
     * boxes.
     *
    ...
    private void initComponents() {
        ...
        // TODO creating a new color
        Color babyBlue=new Color(214,235,242);
        Color babyPink=new Color(234,200,240);
        Color orange = new Color(255,229,181);

        jTextFieldDatabase = new javax.swing.JTextField();
        jScrollPane1 = new javax.swing.JScrollPane();

        // TODO making background baby blue
        jScrollPane1.setBackground(babyBlue);
        jScrollPane1.setOpaque(true);

        jTextArea1 = new javax.swing.JTextArea();

        // TODO making background baby blue
        jTextArea1.setBackground(babyPink);
        jTextArea1.setOpaque(true);

        jScrollPane2 = new javax.swing.JScrollPane();

        // TODO making background baby blue
        jScrollPane2.setBackground(babyBlue);

        jTextArea2 = new javax.swing.JTextArea();

        // TODO making background baby blue
        jTextArea2.setBackground(babyPink);
        ...
        // TODO making background orange
        jTextField5.setBackground(orange);
        ...
        // TODO: We changed the background color to more of a blue color
        jComboBoxQuery.setBackground(babyBlue);
        jComboBoxQuery.setOpaque(true);
        ...
        jConnectButton.setBackground(babyBlue);
        jConnectButton.setOpaque(true);
        jConnectButton.setBorderPainted(false);
        ...
        jBtnRunQuery.setBackground(babyBlue);
        jBtnRunQuery.setOpaque(true);
        jBtnRunQuery.setBorderPainted(false);
   ...
   /**
    * This button will use the data from the textboxes, and attempt to
    * connect to the MYSQL Server. If it is not connected, it will
    ...
    * to the ExecuteQuery function. If it is a query that returns a
    * resultset, it will create a JTABLE which is a
